...
// return temperature measurement from previous BMP180_StartTemperature command
...
// return absolute pressure measurement from previous BMP180_StartPressure command
...
// A: current BMP180_Altitude (meters)
// returns BMP180_Sealevel pressure in mbar

double BMP180_Altitude(double P, double P0);
// convert absolute pressure to BMP180_Altitude (given baseline pressure; sea-level, runway, etc.)
// P: absolute pressure (mbar)
// P0: fixed baseline pressure (mbar)
// returns signed BMP180_Altitude in meters
